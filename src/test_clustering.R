...
#! ----------------------------------------------------------
# df_que <- vroom(".tmp_/clustering_score_barcode05_target", col_names = F)
# df_label <- vroom(".tmp_/clustering_labels_barcode05_target", col_names = c("id", "label"))
# output_suffix <- ".tmp_/clustering_labels_barcode05_target" %>% str_remove(".*labels_")
#! ----------------------------------------------------------
...
# # # cl_num_opt
# # cl_num_opt <- seq(25, 500, by = 25)[cl_num_opt]
# # cl <- hdbscan(pca_res_reduction, minPts = cl_num_opt)
# # # cl$cluster %>% table()
